...
import {faReact, faJs, faHtml5, faCss3, faSass, faBootstrap, faFigma, faNodeJs, faAws, faDocker, faGit, faTrello, faJira, faConfluence} from "@fortawesome/free-brands-svg-icons";
import {faArrowRight,faDatabase,faServer,faTimeline,faBook,faFlask,faLightbulb} from "@fortawesome/free-solid-svg-icons";
...
const projects = [
    {
        ...
        brands: 'STH Japan · Australia Open Travel · FIBA Travel',
